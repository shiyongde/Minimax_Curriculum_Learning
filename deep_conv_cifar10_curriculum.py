...
if __name__ == '__main__':
    if ('--help' in sys.argv) or ('-h' in sys.argv):
        ...
        numpy.savetxt('cifar10_convnet_cLearn_k+10_result.txt', output_seq)
        ...
        plt.savefig('cifar10_convnet_cLearn_k+10.eps', format = 'eps', bbox_inches='tight')
        plt.show()