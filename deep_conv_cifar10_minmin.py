...
def main(num_epochs=60, model=None, 
        learning_rate=1e-2, momentum=0.9, decay_after_epochs = 3, loss_weight = 5.0e+6, curriculum_rate=0.05, 
...
if __name__ == '__main__':
    if ('--help' in sys.argv) or ('-h' in sys.argv):
        ...
        numpy.savetxt('cifar10_convnet_cLearn_minmin_result.txt', output_seq)
        ...
        plt.savefig('cifar10_convnet_cLearn_minmin.eps', format = 'eps', bbox_inches='tight')
        plt.show()