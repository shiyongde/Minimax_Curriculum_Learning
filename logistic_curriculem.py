...
def modularLowerBound(X, k, func, func_parameter, offset, optObj, approx = 0.5, iters = 4):
...
if __name__ == '__main__':
    ...
    numpy.savetxt('mnist_result_nosub.txt', output_seq)
    ...
    plt.savefig('clearn.eps', format = 'eps', bbox_inches='tight')
    plt.show()